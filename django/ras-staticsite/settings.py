"""
Django settings for ras-staticsite project.
...
TEMPLATES_DIRS = os.path.join(SETTINGS_PATH,'templates')
...
ROOT_URLCONF = 'ras-staticsite.urls'
...
WSGI_APPLICATION = 'ras-staticsite.wsgi.application'
